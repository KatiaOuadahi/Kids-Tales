...
public class DataSource {
    ...
    private static void generateStories() {
        ...
        stories.add(new Story(R.drawable.story1_cover, "The Ant and The Grasshopper Story"));
        ...
        stories.add(new Story(R.drawable.story5_cover, "The Little Red Riding Hood Short Story"));
        stories.add(new Story(R.drawable.story6_cover, "The Monkeys and The Cap Seller Story"));
