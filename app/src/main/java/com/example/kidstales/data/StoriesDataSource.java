...
public class StoriesDataSource {
    ...
    private static void generateScenesOfStory01(){
        ...
        ScenesOfStory01.add(new Scene(R.drawable.story1_page1,"When winter came, the ant was lying cozily in his home surrounded by the food he stored during the summer. While the grasshopper hungry and freezing. \n"));
        ScenesOfStory01.add(new Scene(R.drawable.story1_page1,"He asked the ant for food and the ant gave him some. \n" +
                "But it wasn’t enough to last the entire winter."));
        ScenesOfStory01.add(new Scene(R.drawable.story1_page1,"When he tried to ask the ant again, the latter replied: “I’m sorry my friend but my food is just enough for my family to last until the end of winter. \n"));
        ScenesOfStory01.add(new Scene(R.drawable.story1_page1,"If I give you more, we too will starve. We had the entire summer to prepare for the winter but you chose to play instead.”\n"));
    }
    private static void generateScenesOfStory02(){
        ScenesOfStory02=new ArrayList<>();
        ScenesOfStory02.add(new Scene(R.drawable.story2_page2,"There was once a shepherd boy who liked to play tricks. \n" +
        ...
        ScenesOfStory02.add(new Scene(R.drawable.story2_page2,"The next day, he did it again and people rushed to his aid only to be disappointed once again. "));
        ScenesOfStory02.add(new Scene(R.drawable.story2_page2,"On the third day, the boy saw a wolf devouring one of his sheep and cried for help. \n" +
                "But the people who heard him thought this is just another of the boy’s pranks. "));
        ScenesOfStory02.add(new Scene(R.drawable.story2_page2,"So no one came to help him. That day, the boy lost some of his sheep to the wolf.\n"));

    }

    private static void generateScenesOfStory03(){
        ScenesOfStory03=new ArrayList<>();
        ScenesOfStory03.add(new Scene(R.drawable.story3_page4,"There was once a a duckling who from the moment of his birth has always felt different from his siblings."));
        ScenesOfStory03.add(new Scene(R.drawable.story3_page4,"He was always picked on because he didn’t look like the rest of them. \n" +
                "One day, he had enough and ran away from the pond he grew up in. \n"));
        ScenesOfStory03.add(new Scene(R.drawable.story3_page4,"He wandered near and far looking for a family who would accept him. \n" +
        ...
        ScenesOfStory03.add(new Scene(R.drawable.story3_page4,"Upon looking at them, he realized that during the months he spent looking for a family to call his own, he had grown into a beautiful swan.\n" +
                " "));
        ScenesOfStory03.add(new Scene(R.drawable.story3_page4,"Now he finally understood why he never looked like the rest of his siblings because he isn’t a duck but a swan.\n" +
                "\n"));
    }

    private static void generateScenesOfStory04(){
        ScenesOfStory04=new ArrayList<>();
        ScenesOfStory04.add(new Scene(R.drawable.story4_page3,"There was once a hare who was friends with a tortoise. \n" +
                "One day, he challenged the tortoise to a race."));
        ScenesOfStory04.add(new Scene(R.drawable.story4_page3,"Seeing how slow the tortoise was going, \n" +
        ...
        ScenesOfStory04.add(new Scene(R.drawable.story4_page3,"When the hare woke up, he saw that the tortoise was already at the finish line. \n" +
    ...
    private static void generateScenesOfStory05(){
        ...
        ScenesOfStory05.add(new Scene(R.drawable.story5_page1,"He immediately grabbed it between his mouth and took it home. \n"));
        ScenesOfStory05.add(new Scene(R.drawable.story5_page1,"On his way home, he crossed a river and saw another dog who also had a bone in its mouth. \n" +
                "He wanted that bone for himself too."));
        ScenesOfStory05.add(new Scene(R.drawable.story5_page1,"But as he opened his mouth, the bone he was biting fell into the river and sank. \n" +
    ...
    private static void generateScenesOfStory07(){
        ...
        ScenesOfStory07.add(new Scene(R.drawable.story7_page1,"After seeing the round, juicy grapes hanging in a bunch, the fox drooled. \n"));
        ScenesOfStory07.add(new Scene(R.drawable.story7_page1,"But no matter how high he jumped, he couldn’t reach for it. \n"));
        ScenesOfStory07.add(new Scene(R.drawable.story7_page1,"So he told himself that it was probably sour and left. \n" +
    ...
    private static void generateScenesOfStory08(){
        ...
        ScenesOfStory08.add(new Scene(R.drawable.story8_page1,"He would go to the anthill near his home and spray water at the ants. \n" +
                "The ants, with their size, could do nothing but cry. \n"));
        ScenesOfStory08.add(new Scene(R.drawable.story8_page1,"One day, the ants had enough and decided to teach the elephant a lesson. \n" +
                "They went straight into the elephant’s trunk and started biting him. \n"));
        ScenesOfStory08.add(new Scene(R.drawable.story8_page1,"The elephant could only howl in pain. \n"));
        ScenesOfStory08.add(new Scene(R.drawable.story8_page1,"He realized his mistake and apologized to the ants and all the animals he bullied.\n"));
    }
